...
export function SiteFooter({ locale, labels, tools }: SiteFooterProps) {
  return (
    <footer className="border-t border-black/8 bg-[color:var(--color-surface)]">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-[1.2fr_0.8fr_0.8fr] lg:px-8">
